...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::DestroyObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::Initialize(HWND hWnd, GUID * pDriverGUID,
...
// Desc: Creates the internal objects for the framework
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateEnvironment(GUID * pDriverGUID, GUID * pDeviceGUID,
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateDirectDraw(GUID * pDriverGUID, DWORD dwFlags)
{
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateFullscreenBuffers(DDSURFACEDESC2 * pddsd)
{
	HRESULT hr;
...
//  Windowed/fullscreen mode are handled differently.
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateWindowedBuffers()
{
	HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateDirect3D(GUID * pDeviceGUID)
{
...
//       to the renderer
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::CreateZBuffer(GUID * pDeviceGUID)
{
	HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::RestoreSurfaces()
{
...
//-----------------------------------------------------------------------------
VOID CSdlFramework::Move(INT x, INT y)
{
...
VOID CSdlFramework::ClipWindow(long x0, long y0, long x1, long y1)
{
	long height, width;
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::FlipToGDISurface(BOOL bDrawFrame)
{
...
//-----------------------------------------------------------------------------
bool CSdlFramework::RenderError()
{
	return true;
}
...
bool CSdlFramework::StartRender()
{
...
//-----------------------------------------------------------------------------
HRESULT CSdlFramework::ShowFrame()
{
	RECT rc, screct;
